...
export const Dad = () => d1+a2+d2
export const Bee = () => b1+e2+e2
export const banana = () => b2+a2+n2+a2+n2+a2

export const answer1 = () => 'no'
export const answer2 = () => 'no'
export const answer3 = () => 'yes'
